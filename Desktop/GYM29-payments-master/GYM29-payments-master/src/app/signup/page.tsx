...
export default function SignupPage() {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    formData.append('marketingAgreed', marketingAgreed.toString());
            ...
            <CardContent className="space-y-5 pt-0 px-0">
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-center space-x-2">
                  ...
                  >
                    <span className="text-foreground">이용약관</span> 및 <span className="text-foreground">개인정보처리방침</span>에 동의합니다 (필수)
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox 
              ...
              <Button 
                ...
                size="lg"
                disabled={isPending || !termsAgreed || !companyCode}
              >
                {isPending ? "가입 중..." : "회원가입"}
              </Button>
            </CardContent>
